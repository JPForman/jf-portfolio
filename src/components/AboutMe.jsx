  ...
  return (
    <div className="main-container">
      <div className={!darkmode ? "titleWrapper" : "titleWrapper-dark"}>
        <span className="">hello, my name is Joshua Forman</span>
      </div>

      <div className="block">
        <div className="wordWrapper">
          <span className="wordContent">
          I am the lead developer at Class Bucks Llc., a company committed to supporting teachers with a classroom management and content delivery educational web app. My daily stack includes JavaScript, React, and SCSS. I work with great people and love what I do.
          </span>
        </div>
