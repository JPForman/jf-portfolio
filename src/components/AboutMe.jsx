  ...
  return(
    <div>
      ...
      <div className='block'>
        ...
        <h3 className='wordContent'>I am a front end developer. Most recently I have been working with a ton of React to create a classroom management and content delivery educational web app at ClassBucks.</h3>
      </div>

      <div className='block'>
        <h3 className='wordContent'>I love math, film, education, and programming. While I'm not coding at ClassBucks, I teach part-time programming and yoga classes at an DATA Albuquerque Charter School.</h3>
      ...
      <div className='block'>
        ...
        <h3 className='wordContent'>Before working at ClassBucks, I was a front-end developer intern at Theorem Agency where I created client deliverables for companies such as Aflac Insurance, the Portland Trailblazers, and the LA Galaxy. We worked to both create clean front end experiences, as well as process analytic reports for well informed business decisions.</h3>
      </div>

      <div className='full-content'>
        <h2 className='wordContent'>I am enamored with programming and can't wait to see where it takes me next!</h2>
      </div>
